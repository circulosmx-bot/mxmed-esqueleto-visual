...
Hash normalizado PP-310: `c3c0339ad05b127b08288f3a026f2122f9af130061369db2c1a4c0c8d4a17459`. Hash normalizado PP-311: `b0513742662320879fb910595aaa9d4d431f4cf12b72414b6451da7335ae8b76`.
...
| F-029 | SAFE_RETURN | LOW | VERIFIED | Git/bundle permiten revert documental; no existe rollback productivo aprobado (`/tmp/mxmed-activity09-runtime-cutover-readiness-preflight-v2/safe-return-points.txt:1`) | recovery operativo no probado | no | runbook y drill previo a R3/R4 | CUT-03 | D-13,D-14 |
...
Directorio `/tmp/mxmed-activity09-runtime-cutover-readiness-audit-v2-r2/`: diez JSON válidos y cuatro TXT. `route-runtime-matrix.json` contiene 58 rutas; `blocker-decision-register.json` contiene conteos, 13 blockers y 18 decisiones; `source-manifest.txt` registra SHA-256. PP310 hash stable=true, PP311 count=1, PP311 hash=`b0513742662320879fb910595aaa9d4d431f4cf12b72414b6451da7335ae8b76`, PP312 real=0.
