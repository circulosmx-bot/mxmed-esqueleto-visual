    ...
    public function showByDoctorId(string $doctorId, ?string $planOverride = null): array
    {
        ...
        $data = [
            ...
            'professional' => [
                ...
                'bio_long' => $this->firstNonEmpty($professional['bio_long'] ?? null),
                'education' => (array)($professional['education'] ?? []),
                'certifications' => (array)($professional['certifications'] ?? []),
                'professional_associations' => (array)($professional['professional_associations'] ?? []),
                'languages' => [],
                'years_experience' => null,
                // Public audience publishing is not available in the canonical source yet.
                'target_audience' => [],
                'services' => (array)($professional['services'] ?? []),
                'conditions_treated' => (array)($professional['conditions_treated'] ?? []),
            ],
