...
-- Microfase: DB-Suscripciones-ContractAcceptance-IdempotencySchemaDraft-01
-- No ejecutar directamente.
-- No aplicado a DB local ni remota en esta microfase.
-- Requiere revision y QA antes de convertirse en SQL ejecutable.
--
-- Basado en:
...
--
-- Alcance:
-- - Define el borrador de subscription_write_idempotency_keys.
