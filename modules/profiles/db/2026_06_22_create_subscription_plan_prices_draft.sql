-- DRAFT ONLY: conceptual storage for future subscription plan prices.
-- Do not execute this file against any database yet.
-- This is not final executable SQL.
-- This draft does not modify any real database in this microphase.
-- This draft does not add prices or seed data.
-- This draft does not change subscription_plans.
-- This draft does not implement checkout, payments, webhooks, billing or capabilities.
-- Based on PP-Decisiones 67.
