-- SQL ejecutable versionado para crear subscription_contract_acceptances.
-- Proyecto: Mexico Medico / MXMed
-- Microfase: DB-Suscripciones-ContractAcceptance-CreateSchemaExecutable-01
-- No fue ejecutado por esta microfase.
-- Su aplicacion contra DB local o remota requiere microfase posterior explicita.
--
-- Alcance:
-- - Crea la tabla subscription_contract_acceptances.
-- - La tabla conserva auditoria/evidencia legal de aceptacion contractual.
-- - profile_subscriptions conserva snapshot operativo/read-model.
-- - No modifica tablas existentes.
-- - No crea seeds ni datos iniciales.
-- - No crea FKs reales.
-- - No usa tipos enumerados nativos.
...
-- - No se crean aceptaciones free por defecto.
