-- DRAFT ONLY: conceptual storage for future subscription checkout-first flow.
-- Do not execute this file against any database yet.
-- This draft does not create real tables in this microphase.
-- Requires review, schema decision, implementation and QA before becoming executable SQL.
-- Does not connect backend, frontend, payments, productive checkout, billing or capabilities.
-- Based on PP-Decisiones 61, 62 and 63.
