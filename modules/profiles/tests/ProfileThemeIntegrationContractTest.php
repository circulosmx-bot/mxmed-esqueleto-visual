...
theme01aIntegrationAssert(str_contains($css, '--profile-on-light-theme-surface: #113d59;') && substr_count($css, 'var(--profile-on-theme-surface)') >= 7, 'light theme-colored section surfaces use the exact tokenized Director foreground');
...
theme01aIntegrationAssert(str_contains($css, '.mxpp-consultorio-tab--active .mxpp-consultorio-tab__eyebrow') && substr_count($css, 'color: var(--profile-consultorio-fg-selected);') >= 2, 'active consultorio foreground consumes theme accent at 100 percent');
theme01aIntegrationAssert(str_contains($css, '--mxpp-consultorio-unselected-fg: #ffffff;') && substr_count($css, 'color: var(--mxpp-consultorio-unselected-fg);') >= 4, 'unselected consultorio foreground content uses solid white');
