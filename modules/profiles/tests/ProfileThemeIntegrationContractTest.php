...
theme01aIntegrationAssert(str_contains($css, '.mxpp-consultorio-tab--active') && substr_count($css, 'background: var(--mxpp-surface);') >= 2, 'selected and unselected consultorio cards share the canonical white surface');
theme01aIntegrationAssert(str_contains($css, '.mxpp-consultorio-tab--active .mxpp-consultorio-tab__eyebrow') && str_contains($css, 'color: var(--profile-consultorio-fg-selected);'), 'active consultorio foreground consumes theme accent at 100 percent');
theme01aIntegrationAssert(substr_count($css, 'color: var(--profile-consultorio-fg-unselected);') >= 4, 'inactive consultorio foreground consumes theme accent at 50 percent');
