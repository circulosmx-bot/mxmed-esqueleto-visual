...
theme01aIntegrationAssert(str_contains($css, '.mxpp-consultorio-tab--active .mxpp-consultorio-tab__eyebrow') && substr_count($css, 'color: var(--profile-consultorio-fg-selected);') >= 5, 'all consultorio foreground content consumes theme accent at 100 percent');
