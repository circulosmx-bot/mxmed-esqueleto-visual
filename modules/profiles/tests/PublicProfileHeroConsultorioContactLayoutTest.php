...
pdb04dAssert(str_contains($pageSource, 'Material+Symbols+Outlined:') && str_contains($pageSource, 'icon_names=alarm,group'), 'consultation audience and schedule outlined icon font is loaded');
