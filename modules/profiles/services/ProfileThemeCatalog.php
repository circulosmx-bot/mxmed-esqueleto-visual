...
final class ProfileThemeCatalog
{
    ...
    private const THEMES = [
        'mxmed_teal' => ['Turquesa MX Médico', '#10ADBA', '#0A99A6'],
        'medical_blue' => ['Azul Clínico', '#1E88E5'],
        'navy_medical' => ['Azul Profundo', '#1569C7'],
        'soft_lavender' => ['Lavanda', '#B7A6E6'],
        'emerald_green' => ['Verde', '#009E73'],
        'clinical_pink' => ['Rosa', '#E91E63'],
        'dusty_pink' => ['Rosa suave', '#F4B6C2'],
        'soft_coral' => ['Coral', '#FF6F61'],
        ...
        'clinical_light_sky' => ['Azul claro', '#7EC2FF'],
        'royal_blue' => ['Azul profundo brillante', '#00BFFF'],
        'deep_ocean_blue' => ['Azul profundo oscuro', '#0A3D62'],
        'ice_blue' => ['Azul frío', '#CFE2F3'],
    ];
