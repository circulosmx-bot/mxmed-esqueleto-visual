...
if(count($rows)!==37 || hash('sha256',json_encode(array_slice($rows,0,31),JSON_UNESCAPED_SLASHES))!=='8fa58315fcfcf038d3e20a664d2904a60a2e9fc9c9bf9a1dd137180d358025ce')throw new RuntimeException('prior_31_policies_changed');
