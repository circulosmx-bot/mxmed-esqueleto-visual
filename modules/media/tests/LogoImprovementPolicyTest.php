...
if(count($rows)!==35||hash('sha256',json_encode(array_slice($rows,0,32),JSON_UNESCAPED_SLASHES))!=='9680de361389894d730dbbc534adc5c1735a5af46f943005bd7bfa52ce4993c1')throw new RuntimeException('prior_policy_changed');
