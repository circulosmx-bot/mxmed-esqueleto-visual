...
$p->exec('CREATE TABLE media_review_submissions(submission_id TEXT PRIMARY KEY,owner_type TEXT,owner_id TEXT,purpose TEXT,technical_status TEXT,review_status TEXT,created_at TEXT,updated_at TEXT)');
