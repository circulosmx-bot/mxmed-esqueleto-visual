...
if(count($rows)!==36 || hash('sha256',json_encode(array_slice($rows,0,29),JSON_UNESCAPED_SLASHES))!=='72fbcb7bcc953ea039043224d37c626f2d41b46cb4721e08e33db2d7f46c684e')throw new RuntimeException('pre_MR6_policies_changed');
