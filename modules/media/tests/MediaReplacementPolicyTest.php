...
if(count($rows)!==37||hash('sha256',json_encode(array_slice($rows,0,35),JSON_UNESCAPED_SLASHES))!=='cc4904651b6bc93e07dd0846fbe2fdbe905473ff68e6de4ebb5ba01a2881fd89')throw new RuntimeException('prior_35_policies_changed');
