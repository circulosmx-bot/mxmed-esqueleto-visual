...
h01Ok($tests, count($events) === 31 && count(array_unique($events)) === 31, 'canonical_event_count');
h01Ok($tests, $policyEvents === $events, 'policy_catalog_exact_order');
h01Ok($tests, count($rows) === 31, 'policy_row_count');
...
h01Ok($tests, array_merge($combined,['MEDIA_PROFILE_PHOTO_APPROVED','MEDIA_REVIEW_SOURCE_DOWNLOADED','MEDIA_REVIEW_CORRECTED_UPLOADED']) === $events, 'scope_unaccounted_zero');
...
echo "TOTAL_CANONICAL_AUDIT_EVENT_TYPES=31\n";
echo "EVENT_CATALOG_MATCH=31/31\n";
echo "POLICY_REGISTRY_MATCH=31/31\n";
echo "OPERATION_MAPPING=31/31\n";
echo "SOURCE_MODULE_MAPPING=31/31\n";
