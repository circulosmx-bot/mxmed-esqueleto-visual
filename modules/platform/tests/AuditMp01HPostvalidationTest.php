...
h01Ok($tests, count($events) === 38 && count(array_unique($events)) === 38, 'canonical_event_count');
h01Ok($tests, $policyEvents === $events, 'policy_catalog_exact_order');
h01Ok($tests, count($rows) === 38, 'policy_row_count');
...
echo "TOTAL_CANONICAL_AUDIT_EVENT_TYPES=38\n";
echo "EVENT_CATALOG_MATCH=38/38\n";
echo "POLICY_REGISTRY_MATCH=38/38\n";
echo "OPERATION_MAPPING=38/38\n";
echo "SOURCE_MODULE_MAPPING=38/38\n";
