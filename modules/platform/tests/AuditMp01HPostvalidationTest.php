...
h01Ok($tests, count($events) === 43 && count(array_unique($events)) === 43, 'canonical_event_count');
h01Ok($tests, $policyEvents === $events, 'policy_catalog_exact_order');
h01Ok($tests, count($rows) === 43, 'policy_row_count');
...
echo "TOTAL_CANONICAL_AUDIT_EVENT_TYPES=43\n";
echo "EVENT_CATALOG_MATCH=43/43\n";
echo "POLICY_REGISTRY_MATCH=43/43\n";
echo "OPERATION_MAPPING=43/43\n";
echo "SOURCE_MODULE_MAPPING=43/43\n";
