...
final class SourceModuleCatalog
{
    ...
    public function __construct(){if(count(self::MODULES)!==10||count(self::EVENT_MAP)!==31||array_keys(self::EVENT_MAP)!==CanonicalAuditEventType::all())throw new \LogicException('invalid_source_module_catalog');}
