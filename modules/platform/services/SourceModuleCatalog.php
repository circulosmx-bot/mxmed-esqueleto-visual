...
{
    private const MODULES=['AUTH','SESSION','PROFILE','OWNERSHIP','INVITATION','ROLE','SECURITY','ADMIN','SYSTEM','MEDIA'];
    private const EVENT_MAP=['AUTH_REGISTRATION_REQUESTED'=>'AUTH','AUTH_EMAIL_VERIFICATION_SENT'=>'AUTH','AUTH_EMAIL_VERIFIED'=>'AUTH','AUTH_LOGIN_SUCCEEDED'=>'AUTH','AUTH_LOGIN_FAILED'=>'AUTH','AUTH_PASSWORD_RECOVERY_REQUESTED'=>'AUTH','AUTH_PASSWORD_RESET_SUCCEEDED'=>'AUTH','AUTH_PASSWORD_CHANGED'=>'AUTH','AUTH_SESSION_CREATED'=>'SESSION','AUTH_SESSION_ROTATED'=>'SESSION','AUTH_SESSION_REVOKED'=>'SESSION','AUTH_LOGOUT'=>'SESSION','AUTH_LOGOUT_ALL'=>'SESSION','PROFILE_CLAIM_REQUESTED'=>'PROFILE','PROFILE_CLAIM_APPROVED'=>'PROFILE','PROFILE_CLAIM_REJECTED'=>'PROFILE','PROFILE_OWNERSHIP_ASSIGNED'=>'OWNERSHIP','PROFILE_OWNERSHIP_TRANSFERRED'=>'OWNERSHIP','INVITATION_CREATED'=>'INVITATION','INVITATION_ACCEPTED'=>'INVITATION','INVITATION_REVOKED'=>'INVITATION','ROLE_ASSIGNED'=>'ROLE','ROLE_REVOKED'=>'ROLE','STEP_UP_CHALLENGE_SUCCEEDED'=>'SECURITY','STEP_UP_CHALLENGE_FAILED'=>'SECURITY','BREAK_GLASS_STARTED'=>'SECURITY','BREAK_GLASS_ENDED'=>'SECURITY','SENSITIVE_ADMIN_ACTION'=>'ADMIN','MEDIA_PROFILE_PHOTO_APPROVED'=>'MEDIA','MEDIA_REVIEW_SOURCE_DOWNLOADED'=>'MEDIA','MEDIA_REVIEW_CORRECTED_UPLOADED'=>'MEDIA','MEDIA_PHYSICIAN_LOGO_APPROVED'=>'MEDIA'];
    public function __construct(){if(count(self::MODULES)!==10||count(self::EVENT_MAP)!==32||array_keys(self::EVENT_MAP)!==CanonicalAuditEventType::all())throw new \LogicException('invalid_source_module_catalog');}
